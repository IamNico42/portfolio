...
- Bei **jedem ACK** wächst `cwnd` um 1 MSS (solange keine Verluste auftreten)
...
| 4   | 1x DUP-ACK (für Segment 6)  | 20 MSS       | empfängt Segment 6                    | 🔁 **Fast Retransmit** wird ausgelöst  | 50 MSS       | Retransmit Segment 7                |
